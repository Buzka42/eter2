...
- [Handoff](docs/HANDOFF.md) — where the work stands, the queue in dependency
  order, and the things that will bite you. **Read this first.**
...
- [Polish](docs/POLISH.md) — the Polish lexicon, and why each word was chosen over
  its literal translation. [Translations](docs/TRANSLATIONS.md) is the full
  English/Polish pairing, regenerated by `app/tool/pair_translations.py`.
